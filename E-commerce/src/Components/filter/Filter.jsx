...
export default function Filter() {
    ...
    const { mode, toggle, searchkey, setSearchkey, filterType, setFilterType,
        filterPrice, setFilterPrice, product } = context;
        const handleClick=()=>{
           window.location.reload()
           setFilterPrice(value=none)
    ...
    <div className=' container mx-auto px-4 mt-5 '>
         <div className="p-5 rounded-lg bg-gray-100 drop-shadow-xl border border-gray-200"
             ...
             <div className="flex items-center justify-between mt-4">
                 ...
                 <button onClick={handleClick} className="px-4 py-2 bg-gray-50hover:bg-gray-200 text-gray-800 text-sm font-medium rounded-md" style={{ color: mode === 'dark' ? 'white' : '' }}>
                     Reset Filter
                 </button>
             </div>
             <div>
